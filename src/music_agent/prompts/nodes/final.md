...
- Với recommendation:
  ...
  - Không dùng Markdown bold (`**text**` hoặc `__text__`) trong `answer`.
  - Cuối mỗi bài trong `answer` cần có từ `link` trỏ tới Spotify URL nếu recommendation có `spotify_url`.
- Với web fallback:
